...
from pip._vendor.rich.console import (Console, ConsoleOptions, RenderableType,
                                      RenderResult)
...
def open_spinner(message: str) -> Generator[SpinnerInterface]:
...
@contextlib.contextmanager
def hidden_cursor(file: IO[str]) -> Generator[None]:
