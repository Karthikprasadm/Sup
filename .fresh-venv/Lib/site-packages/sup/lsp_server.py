...
from .lsp_utils import (BUILTIN_DOCS, KEYWORDS, build_index,
                        offset_to_position, position_to_offset, word_at)
...
def main() -> int:
    ...
    while True:
        ...
        if method == "initialize":
            ...
            cfg = ((msg.get("params", {}) or {}).get("settings", {}) or {}).get(
                "sup", {}
            )
            ...
            _send_message({"jsonrpc": "2.0", "id": msg.get("id"), "result": [edit]})
            ...
            if fn:
                loc = {
                    ...
                    "range": {
                        "start": {
                            "line": fn["def"]["line"],
                            "character": fn["def"]["character"],
                        },
                        "end": {
                            "line": fn["def"]["line"],
                            "character": fn["def"]["character"] + len(wd),
                        },
                    },
                }
                        ...
                        edits.append(
                            {
                                "range": {
                                    ...
                                    "end": {"line": i, "character": pos + len(wd)},
                                },
                                "newText": new_name,
                            }
                        )
