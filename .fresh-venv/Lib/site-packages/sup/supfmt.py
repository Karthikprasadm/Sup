...
def main() -> int:
    parser = argparse.ArgumentParser(
        prog="supfmt", description="Format SUP source files"
    )
    parser.add_argument("paths", nargs="+", help=".sup files to format")
    parser.add_argument(
        "--check", action="store_true", help="Only check if files would change"
    )
    parser.add_argument(
        "--write", action="store_true", help="Write changes to files in place"
    )
